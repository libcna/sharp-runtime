...
with **13,937 passing tests across 37 test executables**. (This figure had been
...
clean-first rebuild, which their object-layout changes made mandatory — and
ticket #1805 to the current value.)
