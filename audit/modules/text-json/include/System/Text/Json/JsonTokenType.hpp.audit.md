# Audit: `modules/text-json/include/System/Text/Json/JsonTokenType.hpp`
...
The token enum is declarative in this port because no streaming reader is supplied. Values and comments were reviewed with no separate mismatch confirmed.
