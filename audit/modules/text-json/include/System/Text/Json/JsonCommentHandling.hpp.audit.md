# Audit: `modules/text-json/include/System/Text/Json/JsonCommentHandling.hpp`
...
The enum values and their use by document/reader options were checked against the current runtime reference; no standalone mapping discrepancy was found.
