...
- Tests: 13,970 passing across 36 component binaries plus one integration
  binary, verified by ticket #1810 (SR-AUD-132, the interpolated-string
  handler's raw destination pointer) through the full repository gate, raised
  from the 13,958
