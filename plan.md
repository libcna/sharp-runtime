...
- Tests: 13,987 passing across 36 component binaries plus one integration
  binary, verified by ticket #1812 (SR-AUD-242, `ZipArchive`'s null stream)
  through the full repository gate, raised from the 13,979
