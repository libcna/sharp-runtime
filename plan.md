...
- Tests: 13,979 passing across 36 component binaries plus one integration
  binary, verified by ticket #1811 (SR-AUD-257, the compression streams' null
  inner stream) through the full repository gate, raised from the 13,970
