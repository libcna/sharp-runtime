...
*Last verified: 2026-07-29. Branch: `feature/remediation-core-aggregateexception-null-inner`.
The P0
...
dependency edges, and 13,958 tests across 37 executables (the 13,127 figure this
line carried until ticket #1796 was a stale relic: each remediation ticket's own
section below states the count it measured, and the current floor is the 13,958
verified by #1807, raised from the 13,948 verified by #1806 and the 13,937
verified by #1805 — the first three remediation tickets outside `Collections`,
whose changes are confined to `.cpp` bodies, one inline header body and header
doc-comments, so an incremental gate was correct for all three —
