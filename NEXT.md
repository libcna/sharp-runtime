...
dependency edges (90 until ticket #1814 added `Net.Http.Json` -> `Core.Base`), and 14,041 tests across 37 executables (the 13,127 figure this
line carried until ticket #1796 was a stale relic: each remediation ticket's own
section below states the count it measured, and the current floor is the 14,041
verified by #1822, raised from the 14,033
