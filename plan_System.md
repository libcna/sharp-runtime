...
|---|------|-----------|--------|------|
| 1 | Common/src/System/CharArrayHelpers.cs | `System` | `internal` | Internal char array helpers — not needed |
| 2 | Common/src/System/Console/ConsoleUtils.cs | `System` | `internal` | Console utility helpers — not needed (internal) |
| 3 | Common/src/System/CSharpHelpers.cs | `System` | `internal` | CodeDom C# helpers — not needed |
...
| 11 | Common/src/System/Memory/FixedBufferExtensions.cs | `System` | `internal` | Fixed buffer extensions — CLR-specific; not needed |
...
| 21 | Common/src/System/StringPolyfills.cs | `System` | `internal` | Polyfill for older TFMs — not needed |
| 22 | Common/src/System/StrongToWeakReference.cs | `System` | `internal` | Internal weak reference helper — not needed |
| 23 | Common/src/System/TimeProvider.cs | `System` |  | TimeProvider — port (abstract time source) |
| 24 | Common/tests/System/DateTimeTestHelpers.cs | `System` | `internal` | Test infrastructure — skip |
| 25 | Common/tests/System/EnumTypes.cs | `System` | `internal` | Test infrastructure — skip |
| 26 | Common/tests/System/GenericMathHelpers.cs | `System` | `internal` | Test infrastructure — skip |
| 27 | Common/tests/System/MockType.cs | `System` | `internal` | Test infrastructure — skip |
| 28 | Common/tests/System/NonRuntimeType.cs | `System` | `internal` | Test infrastructure — skip |
| 29 | Common/tests/System/ObjectCloner.cs | `System` | `internal` | Test infrastructure — skip |
| 30 | Common/tests/System/RandomDataGenerator.cs | `System` | `internal` | Test infrastructure — skip |
| 31 | Common/tests/System/ShouldNotBeInvokedException.cs | `System` | `internal` | Test infrastructure — skip |
| 32 | Common/tests/TestUtilities/System/AdminHelpers.cs | `System` | `internal` | Test infrastructure — skip |
| 33 | Common/tests/TestUtilities/System/AssemblyPathHelper.cs | `System` | `internal` | Test infrastructure — skip |
| 34 | Common/tests/TestUtilities/System/AssertExtensions.cs | `System` | `internal` | Test infrastructure — skip |
| 35 | Common/tests/TestUtilities/System/DisableParallelization.cs | `System` | `internal` | Test infrastructure — skip |
| 36 | Common/tests/TestUtilities/System/LineEndingsHelper.cs | `System` | `internal` | Test infrastructure — skip |
| 37 | Common/tests/TestUtilities/System/PlatformDetection.cs | `System` | `internal` | Test infrastructure — skip |
| 38 | Common/tests/TestUtilities/System/PlatformDetection.Unix.cs | `System` | `internal` | Test infrastructure — skip |
| 39 | Common/tests/TestUtilities/System/PlatformDetection.Windows.cs | `System` | `internal` | Test infrastructure — skip |
| 40 | Common/tests/TestUtilities/System/RetryHelper.cs | `System` | `internal` | Test infrastructure — skip |
| 41 | Common/tests/TestUtilities/System/TestEnvironment.cs | `System` | `internal` | Test infrastructure — skip |
| 42 | Common/tests/TestUtilities/System/WindowsIdentityFixture.cs | `System` | `internal` | Test infrastructure — skip |
| 43 | Common/tests/TestUtilities/System/WindowsTestFileShare.cs | `System` | `internal` | Test infrastructure — skip |
| 44 | Microsoft.Bcl.Memory/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
| 45 | Microsoft.Bcl.Numerics/src/System/MathF.cs | `System` |  | Single-precision math — port via cmath |
| 46 | System.ComponentModel.Composition/tests/System/LazyHelper.cs | `System` | `internal` | Test infrastructure — skip |
| 47 | System.ComponentModel.Composition/tests/System/ReferenceTracker.cs | `System` | `internal` | Test infrastructure — skip |
| 48 | System.ComponentModel.Composition/tests/System/TypeExtensions.cs | `System` | `internal` | Test infrastructure — skip |
...
| 53 | System.ComponentModel.TypeConverter/src/System/InvariantComparer.cs | `System` | `internal` | Internal invariant string comparer — not needed |
...
| 63 | System.Console/src/System/ConsolePal.Android.cs | `System` | `internal` | Platform-specific (Android) — handle via #ifdef in C++ |
| 64 | System.Console/src/System/ConsolePal.Browser.cs | `System` | `internal` | Platform-specific (Browser) — handle via #ifdef in C++ |
| 65 | System.Console/src/System/ConsolePal.iOS.cs | `System` | `internal` | Platform-specific (iOS) — handle via #ifdef in C++ |
| 66 | System.Console/src/System/ConsolePal.Unix.ConsoleStream.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 67 | System.Console/src/System/ConsolePal.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 68 | System.Console/src/System/ConsolePal.Wasi.cs | `System` | `internal` | Platform-specific (Wasi) — handle via #ifdef in C++ |
| 69 | System.Console/src/System/ConsolePal.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
| 70 | System.Console/src/System/ConsoleSpecialKey.cs | `System` |  | ConsoleSpecialKey enum — port |
| 71 | System.Console/src/System/TermInfo.cs | `System` | `internal` | Unix terminal info — not needed |
| 72 | System.Console/tests/ManualTests/ManualTests.cs | `System` | `internal` | Test infrastructure — skip |
| 73 | System.Data.Common/src/System/Data/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 74 | System.Data.Common/src/System/HResults.cs | `System` | `internal` | Windows HRESULT error codes — not needed |
| 75 | System.Data.Odbc/src/Common/System/Data/Common/AdapterUtil.Odbc.cs | `System` | `internal` | ODBC adapter util — not needed |
| 76 | System.Data.Odbc/src/Common/System/HResults.cs | `System` | `internal` | Windows HRESULT error codes — not needed |
| 77 | System.Data.OleDb/src/System/Data/Common/SR.cs | `System` | `internal` | String resources / assembly info — not needed |
| 78 | System.Diagnostics.DiagnosticSource/src/System/Diagnostics/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 79 | System.Diagnostics.PerformanceCounter/src/misc/EnvironmentHelpers.cs | `System` | `internal` | Internal environment helpers — not needed |
| 80 | System.Diagnostics.Process/tests/LongPath/ClassDefinedInAssemblyWithAVeryLongPath.cs | `System` | `internal` | Test infrastructure — skip |
| 81 | System.DirectoryServices.Protocols/src/System/DirectoryServices/Protocols/ldap/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 82 | System.IO.FileSystem.Watcher/src/System/HResults.cs | `System` | `internal` | Windows HRESULT error codes — not needed |
| 83 | System.IO.Hashing/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
...
| 88 | System.Memory/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
| 89 | System.Memory/tests/TestHelpers.cs | `System` | `internal` | Test infrastructure — skip |
| 90 | System.Memory/tests/TestMemory.cs | `System` | `internal` | Test infrastructure — skip |
| 91 | System.Memory/tests/TInt.cs | `System` | `internal` | Test infrastructure — skip |
| 92 | System.Net.Http.Json/src/System/ArraySegmentExtensions.netstandard.cs | `System` | `internal` | ArraySegment extensions for netstandard compat — not needed |
| 93 | System.Net.HttpListener/src/System/Net/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 94 | System.Net.Http/src/System/Net/Http/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 95 | System.Net.Quic/src/System/Net/Quic/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 96 | System.Net.Security/src/System/Net/Security/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 97 | System.Numerics.Tensors/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
| 98 | System.Private.CoreLib/gen/ProductVersionInfoGenerator.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 103 | System.Private.CoreLib/src/System/Activator.RuntimeType.cs | `System` | `internal` | Activator reflection impl — CLR internal; stub |
...
| 106 | System.Private.CoreLib/src/System/AppContext.Browser.cs | `System` | `internal` | Platform-specific (Browser) — handle via #ifdef in C++ |
| 107 | System.Private.CoreLib/src/System/AppContextConfigHelper.cs | `System` | `internal` | AppContext config helper — not needed |
...
| 111 | System.Private.CoreLib/src/System/AppDomain.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 112 | System.Private.CoreLib/src/System/AppDomainUnloadedException.cs | `System` |  | CLR AppDomain exception — stub |
| 113 | System.Private.CoreLib/src/System/AppDomain.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
| 114 | System.Private.CoreLib/src/System/ApplicationException.cs | `System` |  | ApplicationException — port |
| 115 | System.Private.CoreLib/src/System/ApplicationId.cs | `System` | `internal` | ClickOnce ApplicationId — not needed |
...
| 134 | System.Private.CoreLib/src/System/ByReference.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 135 | System.Private.CoreLib/src/System/Byte.cs | `System` |  | Primitive byte (uint8_t) — port ToString/Parse/formatting |
| 136 | System.Private.CoreLib/src/System/CannotUnloadAppDomainException.cs | `System` | `internal` | CLR-specific exception — stub |
...
| 140 | System.Private.CoreLib/src/System/ComAwareWeakReference.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 149 | System.Private.CoreLib/src/System/DateTimeOffset.Android.cs | `System` | `internal` | Platform-specific (Android) — handle via #ifdef in C++ |
| 150 | System.Private.CoreLib/src/System/DateTimeOffset.cs | `System` |  | DateTimeOffset struct — ported in sharp-runtime |
| 151 | System.Private.CoreLib/src/System/DateTimeOffset.NonAndroid.cs | `System` | `internal` | Platform-specific (NonAndroid) — handle via #ifdef in C++ |
| 152 | System.Private.CoreLib/src/System/DateTime.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 153 | System.Private.CoreLib/src/System/DateTime.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
| 154 | System.Private.CoreLib/src/System/DayOfWeek.cs | `System` |  | DayOfWeek enum — ported |
| 155 | System.Private.CoreLib/src/System/DBNull.cs | `System` | `internal` | DBNull — not needed (database type) |
...
| 158 | System.Private.CoreLib/src/System/DefaultBinder.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 159 | System.Private.CoreLib/src/System/Delegate.cs | `System` | `internal` | Delegate — CLR-specific; port event pattern only |
...
| 164 | System.Private.CoreLib/src/System/Empty.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 167 | System.Private.CoreLib/src/System/Enum.EnumInfo.cs | `System` | `internal` | Enum metadata cache — CLR internal; not needed |
| 168 | System.Private.CoreLib/src/System/Environment.Android.cs | `System` | `internal` | Platform-specific (Android) — handle via #ifdef in C++ |
| 169 | System.Private.CoreLib/src/System/Environment.Browser.cs | `System` | `internal` | Platform-specific (Browser) — handle via #ifdef in C++ |
| 170 | System.Private.CoreLib/src/System/Environment.cs | `System` |  | Environment class — partially ported |
| 171 | System.Private.CoreLib/src/System/Environment.FreeBSD.cs | `System` | `internal` | Platform-specific (FreeBSD) — handle via #ifdef in C++ |
| 172 | System.Private.CoreLib/src/System/Environment.GetFolderPathCore.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 173 | System.Private.CoreLib/src/System/Environment.Haiku.cs | `System` | `internal` | Platform-specific (Haiku) — handle via #ifdef in C++ |
| 174 | System.Private.CoreLib/src/System/Environment.iOS.cs | `System` | `internal` | Platform-specific (iOS) — handle via #ifdef in C++ |
...
| 176 | System.Private.CoreLib/src/System/Environment.NoRegistry.cs | `System` | `internal` | Non-Windows registry stub — not needed |
| 177 | System.Private.CoreLib/src/System/Environment.OSVersion.MacCatalyst.cs | `System` | `internal` | Platform-specific (MacCatalyst) — handle via #ifdef in C++ |
...
| 179 | System.Private.CoreLib/src/System/Environment.OSVersion.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
...
| 183 | System.Private.CoreLib/src/System/Environment.SunOS.cs | `System` | `internal` | Platform-specific (SunOS) — handle via #ifdef in C++ |
| 184 | System.Private.CoreLib/src/System/Environment.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
...
| 186 | System.Private.CoreLib/src/System/Environment.Variables.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 187 | System.Private.CoreLib/src/System/Environment.Variables.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
| 188 | System.Private.CoreLib/src/System/EnvironmentVariableTarget.cs | `System` |  | EnvironmentVariableTarget enum — port |
| 189 | System.Private.CoreLib/src/System/Environment.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
...
| 193 | System.Private.CoreLib/src/System/ExecutionEngineException.cs | `System` | `internal` | CLR internal exception — stub |
...
| 240 | System.Private.CoreLib/src/System/IUtfChar.cs | `System` | `internal` | Internal UTF char interface — not needed |
...
| 243 | System.Private.CoreLib/src/System/LoaderOptimizationAttribute.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 244 | System.Private.CoreLib/src/System/LoaderOptimization.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 245 | System.Private.CoreLib/src/System/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 246 | System.Private.CoreLib/src/System/LocalDataStoreSlot.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 247 | System.Private.CoreLib/src/System/MarshalByRefObject.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 248 | System.Private.CoreLib/src/System/Marvin.cs | `System` | `internal` | Marvin32 string hash (internal) — not needed |
| 249 | System.Private.CoreLib/src/System/Marvin.OrdinalIgnoreCase.cs | `System` | `internal` | Marvin32 string hash (internal) — not needed |
...
| 255 | System.Private.CoreLib/src/System/MemoryDebugView.cs | `System` | `internal` | Debugger view helper — not needed |
...
| 289 | System.Private.CoreLib/src/System/ParseNumbers.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 290 | System.Private.CoreLib/src/System/PasteArguments.cs | `System` | `internal` | CLR internal / not applicable in C++ |
| 291 | System.Private.CoreLib/src/System/PasteArguments.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 292 | System.Private.CoreLib/src/System/PasteArguments.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
...
| 307 | System.Private.CoreLib/src/System/Runtime/InteropServices/ComAwareWeakReference.ComWrappers.cs | `System` | `internal` | COM interop — not needed |
| 308 | System.Private.CoreLib/src/System/RuntimeType.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 335 | System.Private.CoreLib/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
...
| 344 | System.Private.CoreLib/src/System/TimeZoneInfo.FullGlobalizationData.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
...
| 348 | System.Private.CoreLib/src/System/TimeZoneInfo.Unix.Android.cs | `System` | `internal` | Platform-specific (Android) — handle via #ifdef in C++ |
| 349 | System.Private.CoreLib/src/System/TimeZoneInfo.Unix.cs | `System` | `internal` | POSIX implementation — reference for Linux/macOS build |
| 350 | System.Private.CoreLib/src/System/TimeZoneInfo.Unix.NonAndroid.cs | `System` | `internal` | Platform-specific (NonAndroid) — handle via #ifdef in C++ |
| 351 | System.Private.CoreLib/src/System/TimeZoneInfo.Windows.cs | `System` | `internal` | Windows-specific implementation — not needed |
...
| 355 | System.Private.CoreLib/src/System/TupleSlim.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 359 | System.Private.CoreLib/src/System/TypedReference.cs | `System` | `internal` | TypedReference — CLR internal; stub |
...
| 373 | System.Private.CoreLib/src/System/UnitySerializationHolder.cs | `System` | `internal` | CLR internal / not applicable in C++ |
...
| 396 | System.Private.Uri/tests/UnitTests/Fakes/FakeUri.cs | `System` | `internal` | Test infrastructure — skip |
| 397 | System.Private.Xml/src/Misc/HResults.cs | `System` | `internal` | Windows HRESULT error codes — not needed |
| 398 | System.Reflection.MetadataLoadContext/src/System/Reflection/DefaultBinder.CanConvert.cs | `System` | `internal` | CLR reflection binder — not needed |
...
| 406 | System.Runtime.Serialization.Formatters/src/System/Runtime/Serialization/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 407 | System.Runtime/tests/System.Runtime.Extensions.Tests/System/ApplicationIdTests.cs | `System` | `internal` | Test infrastructure — skip |
| 408 | System.Runtime/tests/System.Runtime.Extensions.Tests/TestHelpers.cs | `System` | `internal` | Test infrastructure — skip |
| 409 | System.Security.Cryptography/src/System/Security/Cryptography/X509Certificates/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
| 410 | System.Security.Cryptography.Xml/src/System/Security/Cryptography/Xml/LocalAppContextSwitches.cs | `System` | `internal` | Runtime feature switches — not needed in C++ |
...
| 412 | System.Security.Permissions/src/System/ApplicationIdentity.cs | `System` | `internal` | ClickOnce ApplicationIdentity — not needed |
| 413 | System.Text.Encodings.Web/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
| 414 | System.Text.Encodings.Web/tests/SR.cs | `System` | `internal` | Test infrastructure — skip |
| 415 | System.Text.Json/src/System/ThrowHelper.cs | `System` | `internal` | Internal throw helper — not needed in C++ |
| 416 | System.Text.RegularExpressions/gen/Stubs.cs | `System` | `internal` | Source generator stubs — not needed |
| 417 | System.Threading.Channels/src/System/VoidResult.cs | `System` | `internal` | Internal void result — not needed |
