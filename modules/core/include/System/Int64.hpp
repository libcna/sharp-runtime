...
namespace System {
    ...
    public:
         ...
         * @throws System::OverflowException if the value exceeds Int64 range.
         */
        [[nodiscard]] static longcs Parse(const std::string& input, System::Globalization::NumberStyles style,
        ...
        static bool TryParse(const std::string& input, System::Globalization::NumberStyles style,
                              const IFormatProvider* provider, longcs& result) {
            const std::string s = System::detail::NumberFormatText::NormalizeForParsing(input, style, provider);
         ...
         *        information.
         *
         * C++ counterpart of .NET Int64.ToString(IFormatProvider): the negative sign of the
         ...
         */
        [[nodiscard]] static std::string ToString(longcs value, const IFormatProvider* provider) {
         ...
         *        format information.
         *
         * C++ counterpart of .NET Int64.ToString(string, IFormatProvider): `ToString(value, format)`
