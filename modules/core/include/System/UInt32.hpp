...
namespace System {
    ...
    public:
         ...
         */
        [[nodiscard]] static uintcs Parse(const std::string& input, System::Globalization::NumberStyles style,
         ...
         *        information.
         *
         * C++ counterpart of .NET UInt32.ToString(IFormatProvider): the negative sign of the
         ...
         */
        [[nodiscard]] static std::string ToString(uintcs value, const IFormatProvider* provider) {
         ...
         *        format information.
         *
         * C++ counterpart of .NET UInt32.ToString(string, IFormatProvider): `ToString(value, format)`
        ...
        [[nodiscard]] static std::string ToString(uintcs value, const std::string& format) {
            ...
            if (type == 'B' || type == 'b') {
                std::string s;
                for (int i = 31; i >= 0; --i) s += ((value >> i) & 1u) ? '1' : '0';
