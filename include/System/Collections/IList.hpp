...
public:
     ...
     *
     * C++ counterpart of .NET IList.Add(object). Returns the position at which
     * the new element was inserted, or −1 if the item was not inserted.
     ...
     * @return true if @p value is found in the list; otherwise false.
     */
