...
namespace System::Buffers {
     ...
     * Implementers provide a mutable Span&lt;T&gt; to be filled, then call Advance()
     * to record how many elements were actually written.
     *
    ...
    public:
         ...
         */
        virtual System::Span<T> GetSpan(int sizeHint = 0) = 0;
    };
