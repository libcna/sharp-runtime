...
namespace System {
    ...
    public:
        ...
        Guid();
        /** @brief Initializes a new Guid from a 16-byte array. */
        explicit Guid(const std::array<uint8_t, 16>& bytes);
        /** @brief Parses a Guid from its canonical string representation. */
        ...
        /** @brief Returns the underlying 16-byte array of this Guid. */
